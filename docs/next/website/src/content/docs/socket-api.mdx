...
| Claude sessions | `claude_session.list`, `claude_session.open` |
| Right panel (per pane; `open` takes an optional `pane_id`, width is shared) | `right_panel.toggle`, `right_panel.show`, `right_panel.cycle`, `right_panel.open`, `right_panel.set_width` |

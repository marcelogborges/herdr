...
pub struct Keybinds {
    ...
    pub right_panel_next_mode: ActionKeybinds,
    pub right_panel_previous_mode: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            right_panel_next_mode: empty_action!(),
            right_panel_previous_mode: empty_action!(),
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(
                keybinds.right_panel_next_mode,
                right_panel_next_mode,
                source
            );
            apply_action!(
